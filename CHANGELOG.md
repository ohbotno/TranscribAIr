...
### Changed
- Removed automated CI/CD release workflow (switching to manual releases)
- Simplified build scripts by removing CI environment detection
- Releases will now be created manually with tested executables

### Removed
- GitHub Actions automated release workflow
- CI-specific code paths in build and install scripts
...
### Fixed
- CI/CD workflow: Added missing `build.spec` file to repository
- Updated `.gitignore` to allow committing PyInstaller spec files needed for CI/CD
- Build process now has all required files for automated releases
